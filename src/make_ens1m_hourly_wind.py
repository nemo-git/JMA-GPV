...
Input:
  ENS1M_hourly_YYYYMMDD_UGRD.nc
  ENS1M_hourly_YYYYMMDD_VGRD.nc

Output:
  ENS1M_hourly_YYYYMMDD_WS.nc
  ENS1M_hourly_YYYYMMDD_WD.nc
...
def main(argv=None) -> int:
    ...
    try:
        ...
        out_path_ws = out_dir_ws / f"ENS1M_hourly_{yyyymmdd}_WS.nc"
        out_path_wd = out_dir_wd / f"ENS1M_hourly_{yyyymmdd}_WD.nc"
