#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Create daily (JST-day) statistics from ENS1M hourly netCDF.

Input:
  ENS1M_hourly_YYYYMMDD_VAR.nc  (created previously)
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(description="Create daily mean/min/max from ENS1M hourly netCDF (JST day).")
